...
```ts
import { GraphQLAPI } from '@queelag/core'
...
```ts
import { FetchResponse, GraphQLAPI, GraphQLAPIConfig } from '@queelag/core'
...
```ts
import { FetchResponse, GraphQLAPI } from '@queelag/core'

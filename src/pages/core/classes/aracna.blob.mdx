...
The base64 getter is a convenient way to get the base64-encoded string representation of binary data in a web environment.
...
The uInt8Array getter is a convenient way to get the binary data of a blob in a web environment.

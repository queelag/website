...
import { joinElementClasses, type AlertSeverity, type AlertVariant } from '@aracna/web'
...
export function Alert(props: Props) {
  return (
    <AracnaAlert
      {...props}
      className={joinElementClasses('w-full inline-flex items-center gap-4 leading-tight px-4 rounded border-2 border-slate-700 bg-slate-900', props.className)}
    >

...
The `cloneShallowArray` function creates a shallow copy of an array.
...
The `removeArrayItems` function removes the given items from an array, or removes items that match the given `removes` function.

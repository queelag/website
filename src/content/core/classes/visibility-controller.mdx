...
The `show` method is an asynchronous method used to show an entity. Optionally a delay can be set to delay the showing of the entity.
...
The `hide` method is an asynchronous method used to hide an entity. Optionally a delay can be set to delay the hiding of the entity.
...
The `toggle` method is an asynchronous method used to toggle the visibility of an entity. Optionally a delay which can be different for showing and hiding can be set to delay the visibility change of the entity.

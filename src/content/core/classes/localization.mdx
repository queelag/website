...
import { SB_LOCALIZATION_PACKS, SB_LOCALIZATION_GET, SB_LOCALIZATION_VARIABLES, SB_LOCALIZATION_STORAGE } from '@/definitions/stack-blitz/core/modules'
...
<CodeBlock client:load dependencies={{ '@aracna/core': 'latest' }} files={SB_LOCALIZATION_VARIABLES} template='javascript' title='Localization' console={100} />

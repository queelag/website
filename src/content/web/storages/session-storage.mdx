...
The `SessionStorage` is a `SyncStorage` that uses a `Map` as its storage, which means that it will only be available in the current session.
...
<CodeBlock client:load dependencies={{ '@aracna/core': 'latest' }} files={SB_SESSION_STORAGE_SET} template='javascript' title='SessionStorage' console={100} />
...
<CodeBlock client:load dependencies={{ '@aracna/core': 'latest' }} files={SB_SESSION_STORAGE_GET} template='javascript' title='SessionStorage' console={100} />
...
<CodeBlock client:load dependencies={{ '@aracna/core': 'latest' }} files={SB_SESSION_STORAGE_COPY} template='javascript' title='SessionStorage' console={100} />
...
<CodeBlock client:load dependencies={{ '@aracna/core': 'latest' }} files={SB_SESSION_STORAGE_HAS} template='javascript' title='SessionStorage' console={100} />

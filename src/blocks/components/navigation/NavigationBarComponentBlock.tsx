...
import { ICON_F_FILM, ICON_F_GLOBE, ICON_F_STAR, ICON_F_TRENDING_UP } from '@aracna-icons/feather'
import type { AracnaNavigationBarProps } from '@aracna/react-components'
